...
class TestMainFunctional:
    ...
    def test_redirect_to_constructor_success(self, temp_user_logged_in__return_driver_and_token):
    ...
    def test_redirect_to_order_feed_success(self, temp_user_logged_in__return_driver_and_token):
        driver, token = temp_user_logged_in__return_driver_and_token
        page = MainPage(driver)
    ...
    def test_choose_ingredient_open_popup_success(self, temp_user_logged_in__return_driver_and_token):
        driver, token = temp_user_logged_in__return_driver_and_token
        page = MainPage(driver)
        page.go_to_constructor()
    ...
    def test_ingredient_popup_closing_success(self, temp_user_logged_in__return_driver_and_token):
        driver, token = temp_user_logged_in__return_driver_and_token
        page = MainPage(driver)
        page.go_to_constructor()
        page.click_on_first_ingredient_in_list()
    ...
    def test_add_ingredient_increase_counter_success(self, temp_user_logged_in__return_driver_and_token):
        driver, token = temp_user_logged_in__return_driver_and_token
        page = MainPage(driver)
        page.go_to_constructor()
    ...
    def test_order_registration_success(self, temp_user_logged_in__return_driver_and_token):
        driver, token = temp_user_logged_in__return_driver_and_token
        page = MainPage(driver)
        page.go_to_constructor()
        page.drag_n_drop_first_ingredient_to_burger_constructor()
