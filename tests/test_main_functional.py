...
class TestMainFunctional:
    def test_redirect_to_constructor_success(self, driver_temp_user_logged_in):
    ...
    def test_redirect_to_order_feed_success(self, driver_temp_user_logged_in):
        driver = driver_temp_user_logged_in
        page = MainPage(driver)
    ...
    def test_choose_ingredient_open_popup_success(self, driver_temp_user_logged_in):
        driver = driver_temp_user_logged_in
        page = MainPage(driver)
        page.go_to_constructor()
    ...
    def test_ingredient_popup_closing_success(self, driver_temp_user_logged_in):
        driver = driver_temp_user_logged_in
        page = MainPage(driver)
        page.go_to_constructor()
        page.click_on_first_ingredient_in_list()
    ...
    def test_add_ingredient_increase_counter_success(self, driver_temp_user_logged_in):
        driver = driver_temp_user_logged_in
        page = MainPage(driver)
        page.go_to_constructor()
    ...
    def test_order_registration_success(self, driver_temp_user_logged_in):
        driver = driver_temp_user_logged_in
        page = MainPage(driver)
        page.go_to_constructor()
        page.drag_n_drop(helpers.drag_and_drop_script, MainPageLocators.INGREDIENT_FIRST_IN_LIST, MainPageLocators.BURGER_BASKET)
